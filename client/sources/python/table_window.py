...
class TableWindow(QMainWindow):
    ...
    def update_table_scale(self):
        ...
        for row in range(self.table.rowCount()):
            self.table.setRowHeight(row, int(row_height * self.scale_factor))  
        col_width = 100  
        min_col_width = 100  
        ...
        for row in range(self.table.rowCount()):
            for col in range(self.table.columnCount()):
                ...
                if item is not None:
                    ...
                    font.setPointSize(date_font_size)  
                    item.setFont(font)
        ...
        vertical_header_font.setPointSize(vertical_header_font_size)  
